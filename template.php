...
echo "<a href=alterar.php?cod=$anime[Codanime]><button class=btn>Alterar</button></a>";
echo "<a href=javascript:excluir($anime[Codanime])><button class=btn>Excluir</button></a>";
echo "</div>";
echo "</div>";
echo "</div>";
?>
