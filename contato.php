...
<head>
    ...
    <title>AlLnimation - Contato</title>
</head>
<body class="index">
<?php
    include('connect.php');
...
<div class="box-formulario">        
        ...
        <div class="formulario">
            ...
            <div class="title-form">
              <h1>Fale Conosco</h1>
              <img src="./img/msg_logo.png" alt="Chat" id="chatzinho">
            </div>
            <form action="contato.act.php" method="post">
                <span>
                ...
                <span>
                    <input type="email" class="input-balao-up" id="email" name="email" placeholder="E-mail" autocomplete="off" required=""/>
...
<div class="row">
ALLNIMATION Copyright © 2023 ALLnimation - Todos os direitos reservados
</div>
</div>
</footer>